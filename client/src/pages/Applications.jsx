        ...
        <tbody>
          {userApplications.map((job,index) => true ? (
            <tr key={index}>
              ...
              <td className='py-2 px-4 border-b max-sm:hidden border-gray-200'>{job.jobId.location}</td>
              <td className='py-2 px-4 border-b max-sm:hidden border-gray-200'>{moment(job.date).format('ll')}</td>
