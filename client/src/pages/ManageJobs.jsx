  ...
  return (
    <div className='container p-4 max-w-5xl'>
      <div className='overflow-x-auto'>
        <table className='min-x-full bg-white border border-gray-200 max-sm:text-sm '>
          <thead>
            <tr>
      ...
      <div  className='mt-4 flex justify-end'>
        <button onClick={()=> navigate('/dashboard/add-job')} className='bg-black text-white py-2 px-4 cursor-pointer rounded'  >Add new job</button>
      </div>
    </div>
  )
}
